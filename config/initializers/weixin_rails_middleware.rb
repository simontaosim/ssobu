...
WeixinRailsMiddleware.configure do |config|
  ...
  #config.weixin_token_string = 'b27c8c055226d2175134a76e'
  # using to weixin server url to validate the token can be trusted.
  #config.weixin_secret_string = 'b_dn9K97sGaZHPhDZRwaoqfiDw56qqfw'
  # 加密配置，如果需要加密，配置以下参数
  #config.encoding_aes_key = '26575e63f405ef3c1b5f263dd36c74d828a3e9f46f7'

...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { is_cover: @product_image.is_cover, name: @product_image.name, url: @product_image.url }
    end
  ...
  test "should update product_image" do
    patch :update, id: @product_image, product_image: { is_cover: @product_image.is_cover, name: @product_image.name, url: @product_image.url }
    assert_redirected_to product_image_path(assigns(:product_image))
  end
